...
# the forward chain to sorted key order after apply.
zone_policies = {
...
# router was unfiltered. This is an intentional hardening delta, and it is
# where the ported client-DNS rules land now the resolver is the router.
input_rules = {
